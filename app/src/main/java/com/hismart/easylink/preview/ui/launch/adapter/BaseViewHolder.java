 ...
 * @author qinwendong
 * @date 2018/6/2
 * description RecyclerView.ViewHolder
 */
public abstract class BaseViewHolder<V> extends RecyclerView.ViewHolder {
     ...
     */
    protected abstract void bindData(V itemValue, int position, BaseAdapter.OnItemClickListener listener);
     ...
     * @param listener
     */
    public void setData(V itemValue, int position, BaseAdapter.OnItemClickListener listener) {
