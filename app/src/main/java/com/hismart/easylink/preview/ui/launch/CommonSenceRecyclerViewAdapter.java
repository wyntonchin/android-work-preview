 ...
 * description
 */
public class CommonSenceRecyclerViewAdapter extends RecyclerView.Adapter<CommonSenceRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;

    public CommonSenceRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
